...
class ExcelTestCase extends PHPUnit_Framework_TestCase {
    ...
    {
        $this->assertInstanceOf('Bhargavaaaa\Excel\Excel', $this->excel);
    }
    ...
    {
        $this->phpexcel = m::mock('Bhargavaaaa\Excel\Classes\PHPExcel');
    ...
    {
        $this->reader = m::mock('Bhargavaaaa\Excel\Readers\LaravelExcelReader');
    ...
    {
        $this->writer = m::mock('Bhargavaaaa\Excel\Writers\LaravelExcelWriter');
    ...
    {
        $this->batch = m::mock('Bhargavaaaa\Excel\Readers\Batch');
