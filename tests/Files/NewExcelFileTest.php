...
class NewExcelFileTest extends TestCase {
    ...
    public function testInit()
    {
        ...
        $this->assertInstanceOf('Bhargavaaaa\Excel\Files\NewExcelFile', $exporter);
    }
    ...
    public function testCreateNewFile()
    {
        ...
        $this->assertInstanceOf('Bhargavaaaa\Excel\Writers\LaravelExcelWriter', $exporter->getFileInstance());
    }
