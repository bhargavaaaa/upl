...
trait SingleImportTestingTrait {
    ...
    public function testGet()
    {
        ...
        $this->assertInstanceOf('Bhargavaaaa\Excel\Collections\RowCollection', $got);
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf('Bhargavaaaa\Excel\Collections\RowCollection', $all);
    ...
    public function testFirst()
    {
        ...
        $this->assertInstanceOf('Bhargavaaaa\Excel\Collections\CellCollection', $first);
    ...
    public function testEach()
    {
        ...
        $this->loadedFile->each(function($cells) use($me) {
            ...
            $me->assertInstanceOf('Bhargavaaaa\Excel\Collections\CellCollection', $cells);
    ...
    public function testByConfig()
    {
        ...
        $this->assertInstanceOf('Bhargavaaaa\Excel\Collections\SheetCollection', $config);
    }
    ...
    public function testByConfigCallback()
    {
        ...
        {
            $me->assertInstanceOf('Bhargavaaaa\Excel\Readers\ConfigReader', $config);
        });
